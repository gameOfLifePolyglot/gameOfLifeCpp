...
void Game::tick() {
    ...
    std::set<std::set<Life>> emergedUnflatten;
    std::transform(lives.begin(), lives.end(), std::inserter(emergedUnflatten, emergedUnflatten.end()), [](Life life) { return life.possibleNeighbours(); });
